...
python midi_converter.py -i Mgmt_-_Time_to_Pretend.mid -n TIME_TO_PRETEND -o ../firmware/drsstc_firmware/TimeToPretend.cpp --wav --channel_lock
python midi_converter.py -i Mario-Sheet-Music-Overworld-Main-Theme.mid -n MARIO -o ../firmware/drsstc_firmware/Mario.cpp --wav
